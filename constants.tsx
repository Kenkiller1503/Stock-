...
export const COLORS = {
  blue: '#0055c8', // Brand Blue
  orange: '#f05228', // Accent
  black: '#0b1221',
  darkGray: '#1e293b',
  midGray: '#64748b',
  lightGray: '#e2e8f0',
...
export const NAV_LINKS = [
  { label: 'Thị trường', href: '#trading' },
  { label: 'Danh mục', href: '#dashboard' },
  { label: 'Giao dịch', href: '#trading' },
  { label: 'Sản phẩm', href: '#products' },
  { label: 'Góc nhìn', href: '#insights' },
  { label: 'Về UPBO', href: '#about' },
];
...
export const Icons = {
  ...
  Instagram: (props: React.SVGProps<SVGSVGElement>) => (
    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" {...props}>
